        ...
        <div className="max-w-6xl mx-auto px-4 md:px-8 h-8 flex items-center justify-between gap-4 overflow-hidden">
          <div className="flex items-center gap-4 md:gap-6 truncate">
            ...
            <span className="hidden sm:inline-flex items-center gap-1.5">
              <svg aria-hidden="true" className="w-3 h-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <span className="inline-flex items-center gap-1">
              <svg aria-hidden="true" className="w-3 h-3 text-yellow-300" viewBox="0 0 24 24" fill="currentColor">
