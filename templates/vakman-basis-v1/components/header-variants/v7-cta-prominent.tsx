    ...
    <header className="w-full bg-white border-b border-neutral-200">
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 py-3 md:py-4 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 md:gap-3">
          ...
          >
            <svg aria-hidden="true" className="w-4 h-4 md:w-5 md:h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round">
          ...
          >
            <svg aria-hidden="true" className="w-4 h-4 md:w-5 md:h-5" viewBox="0 0 24 24" fill="currentColor">
